...
!(function (t, e) {
    "object" == typeof exports && "undefined" != typeof module
        ? e(exports, require("jquery"), require("index.html"))
                        ...
                        return e(n).each(function () {
                            ...
                            if (n.data(a)) {
                                ...
                                (c[0] = X.call(this, c[0], "y")),
                                    ...
                                    (s.dur = ne() ? 0 : d),
                                    setTimeout(function () {
                                        null !== c[0] && "undefined" != typeof c[0] && "x" !== r.axis && i.overflowed[0] && ((s.rel = "y"), (s.overwrite = "all"), G(n, c[0].toString(), s)),
                                            null !== c[1] && "undefined" != typeof c[1] && "y" !== r.axis && i.overflowed[1] && ((s.rel = "x"), (s.overwrite = "none"), G(n, c[1].toString(), s));
                                    }, s.timeout);
                            }
                        });
                    }
    ...
    return {
                    ...
                    jQuery(window).on("scroll", function () {
                        if (jQuery(".sticky-header").length > 0) {
                            ...
                            $(window).scrollTop() > e.offset().top
                                ? (e.addClass("is-fixed"), $(".header-style-5 .container > .logo-header .logo").attr("src", "images/logo.png"))
        ...
        load: function () {
            e > 1023 &&
                ...
                jQuery("body").append(
                    '<div class="contant-no-area"><div class="contact-number"><h5>Have A Questions</h5><h6>+800 1947 372336</h6></div><script type="text/javascript" src="../../s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5b221c5e31b4e54b"></script>'
                );
        },
        resize: function () {
...
jQuery(document).ready(function () {
    ...
    jQuery(".img-carousel").owlCarousel({
        ...
        jQuery(".service-carousel").owlCarousel({
            ...
            dots: !1,
            navText: ['<i class="fa fa-chevron-left"></i>', '<i class="fa fa-chevron-right"></i>'],
            responsive: { 0: { items: 1 }, 480: { items: 2 }, 1024: { items: 2 }, 1200: { items: 2.5 }, 1400: { items: 3.7 } },
        }),
        ...
        jQuery(".event-carousel").owlCarousel({
            ...
            dots: !1,
            navText: ['<i class="fa fa-chevron-left"></i>', '<i class="fa fa-chevron-right"></i>'],
            responsive: { 0: { items: 1 }, 480: { items: 2 }, 767: { items: 3 }, 1000: { items: 3 } },
        }),
...
function contactForm() {
    ...
    (window.verifyRecaptchaCallback = function (e) {
        ...
        $(".dzSubscribe").on("submit", function (t) {
            t.preventDefault();
            var s = $(this).attr("action"),
                a = $(this).serialize();
            $.ajax({
    ...
    $(function () {
        ...
        addSwitcher(),
            ...
            jQuery(".skin-1").on("click", function () {
                return jQuery(".skin").attr("href", "css/skin/skin-1.css"), jQuery(".logo-header img").attr("src", "images/logo.png"), !1;
            }),
            jQuery(".skin-2").on("click", function () {
                return jQuery(".skin").attr("href", "css/skin/skin-2.css"), jQuery(".logo-header img").attr("src", "index.html"), !1;
            }),
            jQuery(".skin-3").on("click", function () {
                return jQuery(".skin").attr("href", "index.html"), jQuery(".logo-header img").attr("src", "index.html"), !1;
            }),
